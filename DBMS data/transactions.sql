...
VALUES
('100102010102040111CC', 3000, STR_TO_DATE("01-01-2022 20:40:10", "%m-%d-%Y %H:%i:%s"), 'PROCESSED'),
...
('100302020603020111CX', 160000, STR_TO_DATE("08-21-2020 16:39:20", "%m-%d-%Y %H:%i:%s"), 'PROCESSED'),
