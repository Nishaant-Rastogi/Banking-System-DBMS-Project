...
('1001020205010101', 71000, STR_TO_DATE("01-02-2022 09:10:10", "%m-%d-%Y %H:%i:%s"), 'PROCESSED'),
('1001020205010102', 64000, STR_TO_DATE("02-02-2022 12:05:01", "%m-%d-%Y %H:%i:%s"), 'PROCESSED'),
('1002020202020101', 92500, STR_TO_DATE("02-12-2022 22:10:20", "%m-%d-%Y %H:%i:%s"), 'PROCESSED'),
...
('1003020206030201', 160000, STR_TO_DATE("08-21-2020 16:39:20", "%m-%d-%Y %H:%i:%s"), 'PROCESSED'),
...
('1005020201050101', 20000, STR_TO_DATE("01-10-2022 21:18:28", "%m-%d-%Y %H:%i:%s"), 'PROCESSED'),
...
('1005020205050101', 160000, STR_TO_DATE("05-26-2020 15:20:49", "%m-%d-%Y %H:%i:%s"), 'PROCESSED'),
